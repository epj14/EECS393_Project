...
public class ResumeCVInputNewest extends javax.swing.JFrame {

    /**
     * Creates new form ResumeCVInputNewest
     */
    ...
    public ResumeCVInputNewest(String templatePath, String outputPath) {
        initComponents();
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        int returnValue = saveChooser.showSaveDialog(ResumeCVInputNewest.this);
    ...
    private void jButton4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton4MouseClicked
        ...
        if (isSaved == false){
           ...
           try{
                ...
                int returnVal = pdfChooser.showSaveDialog(ResumeCVInputNewest.this);
           if (returnVal == JFileChooser.APPROVE_OPTION){
               String outputPath = pdfChooser.getSelectedFile().getAbsolutePath();
               String inputPath = jTextField1.getText();
               PDFWriter pdfwriter= new PDFWriter(inputPath, outputPath);
               pdfwriter.writePDF();
           }
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ResumeCVInputNewest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            if (args.length > 0)
                new ResumeCVInputNewest(args[0], args[1]).setVisible(true);
            else
                new ResumeCVInputNewest().setVisible(true);
            }
        });
    }
/*
